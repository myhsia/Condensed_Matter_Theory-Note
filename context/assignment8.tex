...
\begin{solution}\leavevmode
  \begin{enumext}
    ...
    \]
    Then, the area of the isoenergetic contour is
    \[
      A = \pi k_\parallel^2 = \frac{2\pi m_{xx} E_k}{\hbar^2}.
    \]
    Substitute to the definition of cyclotron mass, we can obtain
    \[
      m_c = \frac{\hbar^2}{2\pi} \pdv A{E_k}
    = \frac{\hbar^2}{2\pi} \pdv A{E_k}
    = \frac{\hbar^2}{2\pi} \frac{2\pi m_{xx}}{\hbar^2} = m_{xx}.
    \]
    \item Simply take $\bm B \parallel \hat x$, then orbits lie in the
